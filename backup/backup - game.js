...
$(document).ready(function () {
    ...
    function init() {
        ...
        var length = tracks.length - 1;
        audio[0].volume = .10;

        // výběr položky z playlistu a zavolání přehrávání
        ...
        // přehrání dalšího souboru po skončení aktuálního
    ...
    // přehrávání, aktualizace přidávaných tříd
